      ...
      <form @submit.prevent="HandleUpdateUserInfo">
        <div :class="['field', field.name]" v-for="field in fields" :key="field.name">
          ...
          <div class="custom-input">
            <input
              type="text"
              :id="field.name"
              :disabled="field.disabled || inputData.IsDefault"
        ...
        <div class="field avatar">
          <div class="update-avatar">
            ...
            <label :class="['img-file', { disabled: inputData.IsDefault }]" for="img-file"
              >變更頭像</label
            >
            <input
        ...
        <div class="btns">
          <button type="submit" class="save-btn" :disabled="userData.is_default === true">
            儲存
          </button>
